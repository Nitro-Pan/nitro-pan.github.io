---
layout: post
title:  "Legitimate Unemployment - Hong Kong"
date:   2026-05-11 00:00:00 +0800
categories: travel fun solo
permalink: /legitmate-unemployment-hongkong/
---
...
<div class="col-info-table-container">
    ...
    {%- include credit-image.html src="/assets/images/hongkong/flight-beginning.jpg" alt="Me looking happy in my plane seat, right after I left" credit="All Good!" -%}
    </div>
    <div class="col-info-table flex-second">
    {%- include credit-image.html src="/assets/images/hongkong/flight-end.jpg" alt="Me looking completely expired at the end of my flights" credit="Actively Dying" -%}
    </div>
</div>
...
<div class="blog-image">
{%- include credit-image.html src="/assets/images/hongkong/dim-sum-lunch.jpg" alt="Dim Sum on a restaurant table" credit="Dim Sum from The Steam Hut in Tsuen Wan"  -%}
</div>
...
<div class="blog-image">
{%- include credit-image.html src="/assets/images/hongkong/beef-noodles.jpg" -%}
</div>
...
<div class="col-info-table-container">
    <div class="col-info-table flex-first">
    {%- include credit-image.html src="/assets/images/hongkong/skewer-kitchen-dinner.jpg" alt="a variety of skewers" credit="A ton of different skewers from Skewer Kitchen in Tsuen Wan" -%}
    </div>
    <div class = "col-info-table flex-second">
    {%- include credit-image.html src="/assets/images/hongkong/dinner-from-zac.jpg" alt="idk what this stuff is, just a bunch of traditional chinese dishes in a table" credit="Way too much food that I got with Zac" -%}
    </div>
</div>
...
<div class="blog-image">
{%- include credit-image.html src="/assets/images/hongkong/the-museum-cube.jpg" alt="a container for holding huge stamp seals" credit="The Cube. (it holds big seals)"  -%}
</div>
...
<div class="blog-image">
{%- include credit-image.html src="/assets/images/hongkong/night-avenue-of-stars.jpg" alt="me, on the avenue of stars at night" credit="The Avenue of Stars, at night feat. Me"  -%}
</div>

<div class="blog-image">
{%- include credit-image.html src="/assets/images/hongkong/hong-kong-park.jpg" alt="hong kong park" credit="Hong Kong Park" -%}
</div>

<div class="blog-image">
{%- include credit-image.html src="/assets/images/hongkong/victoria-peak.jpg" alt="Cow at Victoria Peak" credit="Spotted at Victoria Peak"  -%}
</div>
...
<div class="col-info-table-container">
    <div class="col-info-table flex-first">
    {%- include credit-image.html src="/assets/images/hongkong/luckiest-boat-alive.jpg" alt="a man on a boat labeled 88888" credit="" -%}
    </div>
    <div class = "col-info-table flex-second">
    {%- include credit-image.html src="/assets/images/hongkong/cheung-chau-selfie.jpg" alt="me!" credit="" -%}
    </div>
</div>
...
<div class="col-info-table-container">
    <div class="col-info-table flex-first">
    {%- include credit-image.html src="/assets/images/hongkong/backrooms-1.jpg" alt="" credit="" -%}
    </div>
    <div class = "col-info-table flex-second">
    {%- include credit-image.html src="/assets/images/hongkong/backrooms-2.jpg" alt="" credit="" -%}
    </div>
</div>
